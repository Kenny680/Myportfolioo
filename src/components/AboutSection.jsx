    ...
    <section id="about" className="py-24 px-4 relative" ref={containerRef}>
      <div className="container mx-auto max-w-6xl">
        ...
        <p className="text-center text-gray-400 text-lg max-w-2xl mx-auto mb-12">
          <VariableProximity
            label="Aspiring Data Scientist pursuing BSc (HONS) at Birmingham City University. Proficient in Python, data visualization, React, JavaScript UI/UX, Figma and machine learning with hands-on experience in data analysis. Active member of the Data Science Club, passionate about leveraging data to drive insights and solve problems."
            containerRef={containerRef}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <SkillCard
              ...
              description="                             Developing mobile apps with smooth user experience."
            />
          </div>
        </div>
      </div>

      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-semibold mb-4">Contact Through</h3>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <a
                    href="mailto:kunalkhadka85@gmail.com"
                    className="text-muted-foreground hover:text-primary transition-colors text-sm"
                  >
                    kunalkhadka85@gmail.com
                  </a>
                </div>
              </div>
            ...
            {/* Connect With Me */}
            <div className="mt-6">
              <h4 className="font-medium mb-2 text-sm text-center">Join With Me</h4>
              <div className="flex justify-center space-x-4">
                <a
                  href="https://www.https://www.linkedin.com/in/kunal-khadka/?trk=opento_sprofile_detailslinkedin.com/in/nirdosh-khadka-np/"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/kennychetri?igsh=MXgwenZkZTRvZmEwaQ%3D%3D&utm_source=qr"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <Instagram size={18} />
                ...
                <a
                  href="https://github.com/Kenny680"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <Github size={18} />

      ...
      <div className="container max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center z-10">
        ...
        <div className="space-y-6 text-center md:text-left">
          <h1 className="text-4xl md:text-4xl font-bold tracking-tight">
            ...
            <VariableProximity
              label={`Kunal Khadka`}
              className="text-primary -opacity-50 animate-fade-in-delay-1"
          ...
          <VariableProximity
            label={`Data Science student at Birmingham City University with skills in Python, machine learning, and data visualization. Passionate about turning data into insights and solutions.`}
